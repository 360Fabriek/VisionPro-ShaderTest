...
namespace PolySpatial.Template
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            if (m_SpawnCnt < m_ObjectPrefabs.Count && isSpawnOptionRandomized)
            {
                objectIndex = m_SpawnCnt;
            }
            ...
            var spawnEulerAngles = new Vector3(0, projectedAngle + randomRotation, 0);
            newObject.transform.eulerAngles = spawnEulerAngles;
